...
import com.daixu.jandan.view.pic.PicPresenter;
...
public class MeiziFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, MeiziContract.View {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                switch (view.getId()) {
                    case R.id.img_max_src: {
                        Intent intent = new Intent(MeiziFragment.this.getActivity(), ImageDetailActivity.class);
                ...
                mRecyclerView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (isEnd) {
                            ...
                            //成功获取更多数据
                            mPresenter.getPic("jandan.get_ooxx_comments", mPage);
                        }
                    }
                }, 200);
            }
    ...
    public void getPicSuccess(OtherBean resp) {
        Timber.tag("MeiziFragment").e("getPicSuccess resp=" + resp);
        hideProgress();
    ...
    public void getPicFailure() {
        Timber.tag("MeiziFragment").e("getPicFailure");
        hideProgress();
    }
